...
`   
   ...
   `,
`
١- (جايين يا أبانا اسمع لدعانا بتواضع يرجع شعبك
يطلب رحمة من عندك بقلوب محتاجه إليك) 2

القرار – ( ده رجانا فيك يا إلهنا وهنستنى المواعيد نحوك نرفع أعيننا وايمانا فيك بيزيد
بنصدق كل وعودك دا انت في الوعد أمين تملا حياتنا من جودك مجداً ليك يا معين )

2- (أرضنا عطشانة بجروح مليانة من فيض حبك ترويها
لمسة إيدك تشفيها وتردها تاني إليك) 2

3- (بنتوب قدامك بنعود لحنانك نعلن ملكك في حياتنا
في بيوتنا وإجتماعاتنا وقلوبنا تسجد ليك) 2
`, `
...
describe('testBreaker', () => {
    ...
    it('returns text by lines without slide info', ()=>{
        ...
        expect(slides[0].text).toHaveLength(2);                
        expect(slides[0].text[0]).toEqual('(جايين يا أبانا اسمع لدعانا بتواضع يرجع شعبك');
